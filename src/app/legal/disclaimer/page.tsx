      ...
      <section className="relative py-16 sm:py-24 md:py-32 overflow-hidden" style={{ background: "#0F0F12" }}>
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-14">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mt-4 mb-4 text-white">Disclaimer</h1>
            ...
            {[
              {
                ...
                content: <p>The information provided on Darkhaven&apos;s website and through our services is for general informational and technology reference purposes only. While we strive to keep the information accurate and up to date, we make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, or suitability of the information, products, services, or related graphics for any particular purpose.</p>,
              },
              {
                title: "No Financial Advice",
                content: <p>Darkhaven is a technology and infrastructure company. Nothing on this website or in our services constitutes financial advice, investment advice, trading advice, or any other form of advisory service. You should not interpret any content as a recommendation to buy, sell, or hold any financial instrument or participate in any particular trading or investment strategy.</p>,
              },
              {
                title: "Technology Services Only",
                content: <p>Darkhaven provides technology infrastructure, software engineering, and data systems services. We do not provide brokerage, trading, or financial services of any kind. Our platform and tools are designed for technology operations, system management, and digital infrastructure support only.</p>,
              },
              {
                title: "Limitation of Liability",
                content: <p>In no event shall Darkhaven, its directors, employees, partners, agents, suppliers, or affiliates be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation loss of data, profits, or goodwill arising from your access to or use of (or inability to access or use) our services.</p>,
              },
              {
              ...
              },
              {
                ...
                content: <p>Darkhaven does not guarantee that our services will be available at all times or without interruption. We may experience hardware, software, or other problems resulting in interruptions, errors, or loss of data. We are not responsible for any damages or losses arising from such interruptions.</p>,
              },
              {
                title: "Changes to This Disclaimer",
                content: <p>We reserve the right to update or modify this disclaimer at any time without prior notice. Changes become effective immediately upon posting to the website. Your continued use of our services following any changes constitutes acceptance of the updated disclaimer.</p>,
              },
              {
                title: "Contact Us",
                content: (
