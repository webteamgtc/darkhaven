      ...
      <section className="relative py-16 sm:py-24 md:py-32 bg-dark overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <span className="text-sm font-medium text-blue-light uppercase tracking-widest">Legal Center</span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-4xl mx-auto">
            {legalPages.map((page, i) => (
              <Link
                key={i}
                href={page.href}
                className="group bg-dark-2 rounded-2xl border border-white/[0.06] p-6 sm:p-8 hover:border-blue/20 hover:shadow-lg hover:shadow-blue/5 transition-all duration-300"
              >
                ...
                <h2 className="text-lg font-semibold text-white mb-2 group-hover:text-blue-light transition-colors">{page.title}</h2>
                <p className="text-text-light-3 text-sm leading-relaxed">{page.description}</p>
                <div className="mt-4 flex items-center gap-1 text-blue-light text-sm font-medium">
                  Read More
