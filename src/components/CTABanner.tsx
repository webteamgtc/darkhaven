      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-text-dark-3 text-lg mb-8 leading-relaxed">
          ...
          >
            <div className="bg-light rounded-2xl p-8 border border-black/[0.04] shadow-lg shadow-blue/5">
              <h3 className="text-xl font-semibold text-text-dark mb-6">Request a Demo</h3>
